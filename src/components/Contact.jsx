...
function Contact() {
    return (
        <section className='container mt-20 flex flex-col-reverse sm:flex-row'>
            ...
            <form className='container p-5 sm:max-w-xl flex flex-col border border-blue-950 rounded m-auto sm:py-40'>
                ...
                dark:bg-transparent dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Leave a comment...">
                </textarea>
