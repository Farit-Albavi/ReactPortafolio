...
function Contact() {
    return (
        <section className='container mt-20 flex flex-col-reverse sm:flex-row'>
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d757.0069129128622!2d-57.565792712318256!3d-25.506646393499484!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMjXCsDMwJzI1LjIiUyA1N8KwMzMnNTguNCJX!5e0!3m2!1ses-419!2spy!4v1688369812009!5m2!1ses-419!2spy"
                className='w-full h-96 sm:h-full hidden sm:block'
                allowfullscreen="" loading="lazy"
                referrerpolicy="no-referrer-when-downgrade">
            </iframe>

            <form className='container p-5 sm:max-w-xl flex flex-col border dark:border-blue-950 rounded m-auto sm:py-40'>
                ...
                <div className="relative">
                 ...
                 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-transparent dark:border-gray-600 dark:placeholder-gray-400 dark:text-white
                ...
                dark:bg-transparent dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Leave a message...">
                </textarea>
            ...
            text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:hover:bg-blue-500 dark:focus:ring-blue-800">Send</button>
            </form >
