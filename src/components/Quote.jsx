...
function Quote() {
    return (
        <figure class="max-w-screen-md mx-auto text-center py-20">
            ...
            <figcaption class="flex items-center justify-center mt-6 space-x-3">
                ...
                <div class="flex items-center divide-x-2 divide-gray-500 dark:divide-gray-700">
                    <cite class="pr-3 font-medium text-gray-900 dark:text-white">Farit Albavi</cite>
                    <cite class="pl-3 text-sm text-gray-500 dark:text-gray-400">Web Developer</cite>
                </div>
            </figcaption>
        </figure>)
}
